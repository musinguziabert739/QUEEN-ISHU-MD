...
console.log("CONNECTING QUEEN-ISHU-MD BOT🧬...");
...
console.log('QUEEN-ISHU-MD CONNECTED TO WHATSAPP ENJOY ✅')
...
⁠⁠⁠⁠╰──────────────⊷❒`;
conn.sendMessage(conn.user.id, { image: { url: `https://i.imgur.com/vzDwkjg.jpeg` }, caption: up })
...
//================ownerreact==============
if(senderNumber.includes("94760698006")){
if(isReact) return
m.react("👑")
}
if(senderNumber.includes("94760698006")){
...
app.get("/", (req, res) => {
res.send("HEY, QUEEN-ISHU-STARTED ✅");
});
